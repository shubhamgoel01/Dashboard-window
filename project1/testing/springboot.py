...
applications = {
    ...
    "Nodejs": ("https://endoflife.date/nodejs", '.lifecycle .release:nth-of-type(3) td:nth-of-type(5) a'),
    "MySQL-8": ("https://endoflife.date/mysql", '.lifecycle .release:nth-of-type(5) td:nth-of-type(5) a'),
    ...
    "Rails": ("https://endoflife.date/rails", '.lifecycle .release:nth-of-type(1) td:nth-of-type(4) a'),
}
